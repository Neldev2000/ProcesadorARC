...
define SRCS
	main.cpp \
	./INSTRUCTION_MEMORY/InstructionMemory.cpp \
	./ADDER4/Adder4.cpp \
	./Alu/Alu.cpp \
	./CONTROL_UNIT/ControlUnit.cpp \
	./CONTROL_UNIT/OUT/ALUOp0.cpp ./CONTROL_UNIT/OUT/ALUOp1.cpp ./CONTROL_UNIT/OUT/ALUOp2.cpp ./CONTROL_UNIT/OUT/AluSrc.cpp ./CONTROL_UNIT/OUT/Branch.cpp ./CONTROL_UNIT/OUT/MemRead.cpp ./CONTROL_UNIT/OUT/MemtoReg.cpp ./CONTROL_UNIT/OUT/MemWrite.cpp ./CONTROL_UNIT/OUT/RegWrite.cpp \
	./ExMem/ExMem.cpp \
	./GATES/AND/And.cpp ./GATES/AND/And3.cpp ./GATES/AND/And4.cpp ./GATES/AND/And5.cpp \
	./GATES/MUX/Mux2a1.cpp \
	./GATES/NAND/Nand.cpp \
	./GATES/NOR/Nor.cpp ./GATES/NOR/Nor3.cpp ./GATES/NOR/Nor4.cpp ./GATES/NOR/Nor5.cpp \
	./GATES/NOT/Not.cpp \
	./GATES/OR/Or.cpp ./GATES/OR/Or3.cpp ./GATES/OR/Or4.cpp ./GATES/OR/Or5.cpp \
	./GATES/XNOR/Xnor.cpp ./GATES/XNOR/Xnor3.cpp ./GATES/XNOR/Xnor4.cpp \
	./GATES/XOR/Xor.cpp ./GATES/XOR/Xor3.cpp ./GATES/XOR/Xor4.cpp \
	./IMMGEN/immgen.cpp \
	./MemWb/MemWb.cpp \
	./PIPELINE_ID_EX/pipeline_id_ex.cpp \
	./PIPELINE_IF_ID/pipeline_if_id.cpp \
	./PROGRAM_COUNTER/program_counter.cpp \
	./REGISTER_FILES/register_files.cpp
endef      
...
define INCDIR
	...
	-I./PROGRAM_COUNTER/ \
	-I./REGISTER_FILES/ \
	-I$(SYSTEMC_HOME_BY_VERSION)/include 
endef
